      ...
      <div className="newBookingsMainContainer">
        ...
        >
          <Grid xs={5} sm={5} md={5} lg={5.5} xl={5} className="backIconDiv">
            <TiArrowBack onClick={() => History(PATHS.MANAGERBOOKINGMANAGEMENT)} id="viewBookingsBackBtnId" size={30} />
          </Grid>
          <Grid
            xs={7}
            sm={7}
        ...
        <Grid container className="formContainer">
          <Grid container>
            <Grid xs={12} sm={5.5} md={5.5} lg={5.5} xl={5.5}>
              <div className="customSelect bookingType">
                ...
                <input type="text" className="addUserInputField" id="viewBookingsBookingTypeId" value={BookingState.viewbooking?.data.data.bookingTypeId == 1 ? "Room Booking" : "Special Day Booking"} readOnly></input>
              </div>
            </Grid>
          ...
          <Grid xs={12} className="bookButtonDiv">
            <div onClick={() => History(PATHS.MANAGERBOOKINGMANAGEMENT)} id="viewBookingsOkBtnId" className="pointDetails_Previous">Back</div>
          </Grid>
        </Grid>
      </div>
    </Grid>
